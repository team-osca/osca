...
<head>
    ...
    <title>결제창 만들기</title>
    <link rel="stylesheet" href="../main-cafe/cafe-all.css">
    <link rel="stylesheet" href="../main-cafe/main-cafe-header.css">
    <link rel="stylesheet" href="../main-cafe/cafe-footer.css"> 

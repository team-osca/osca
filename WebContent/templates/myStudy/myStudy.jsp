...
<html>
  <head>
    ...
    <title>내 스터디</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/myStudy/css/myStudy.css" />
  ...
  <script src="${pageContext.request.contextPath}/static/myStudy/js/myStudy.js"></script>
</html>
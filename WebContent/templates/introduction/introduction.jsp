...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/introduction/css/introduction.css">
        ...
        <div id="header">
            <div class = "header_wrapper common_wrapper">
                <div class="header_nav_logo">
                    <a href="#vision">
                        <img src="${pageContext.request.contextPath}/static/allimages/logo.jpg" alt=""" height="18px" width="82px" alt="Oh!스카 로고">
                    </a>

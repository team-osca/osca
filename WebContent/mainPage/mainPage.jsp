                        ...
                        <div class="matched_jobList_aiBanner">
                            <div class="matched_jobList_aiBanner_container">
                                <div class="matched_jobList_aiBanner_container_titleWrapper">
                                    <img src="/allimages/logo.jpg" width="113" alt="logo-wantedai" style="margin-bottom: 3px;">
                                    <p class="matched_jobList_aiBanner_container_titleWrapper_title">와 함께하는 새로운 삶의 시작! </p>
                                </div>
                                <p class="Typography_matched_jobList_aiBanner_container_titleWrapper">
                                    회원가입 후, 다양한 스터디와 스터디카페에 대한 정보를 제공받고,
                                    <br ::after></br>
                                    원하는 공부를 원하는 곳에서 하세요!
                                </p>
                            </div>

					...
					<div class="mainbar-nav-top">
						<div class="mainbar-nav-logo">
							<a href="/jobsfeed" class="mainbar-logo-plus"
								...
								src="logo/logo.png" alt="logo" width="74" height="17" /></a>
						</div>
			...
			<div class="Status">
				<div class="Aside-inStatus">
					<dl>
						...
						<dd>
							<ul>
								<li class="active"><a href="#" class="">전체
							...
							<li class="List-List-table-tr">
								<div role="presentation">
									<span class="List-List-table-td List-List-table-td-cafe-logo"><img
										...
										글로벌 서비스(Nowcom Global Service – Korea LLC)</span><span
										class="List-List-table-td List_List_table_td_position__8yMM_">Jr.
										Database Engineer</span><span
										class="List-List-table-td List-List-table-td-create-time">2023.
										6. 26</span><span
										class="List-List-table-td List-List-table-td-status">접수</span><span
										class="List-List-table-td List-List-table-td-recommendation">추천인
										없음</span><span class="List-List-table-td List-List-table-td-reward"></span>
								</div>
							</li>

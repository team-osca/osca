                ...
                <nav class="main-bar-nav">
                    <div class="main-bar-nav-top">
                        <div class="main-bar-nav-top-logo">
                            <button type="button" aria-label="job category menu button" class="main-bar-hamberger">
                            ...
                            <a href="" class="main-bar-nav-top-logo-a" aria-label="jobsfeed link" >
                    ...
                    <aside class="aside isLoggedIn">
                        <ul>
                            ...
                            <li class="profile mdMoreVisible">
                                <button type="button" aria-haspopup="true" aria-expanded="false"  class="profileButton" aria-label="avatarButton" >
                            ...
                            <li class="aside_visibleMenu">
                                <button class="menuButton" aria-label="menuButton" type="button">
            ...
            <div class="container">
                <aside class="__aside container_aside">
                    <header class="aside-header">
                        ...
                        <a href="setting.html" class="aside-edit" target="_blank" rel="noopener noreferrer">기본정보 수정</a>
                    </header>
